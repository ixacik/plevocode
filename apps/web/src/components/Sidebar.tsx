...
export default function Sidebar() {
  ...
  const { getIconOverride, setIconOverride } = useProjectIcons();
      ...
      <>
        <div className="group/project-header relative">
          ...
          >
            ...
            <ProjectIconPicker
              currentOverride={getIconOverride(project.id)}
              onSelect={(override) => setIconOverride(project.id, override)}
            >
              <ProjectFavicon
                cwd={project.cwd}
                iconOverride={getIconOverride(project.id)}
                interactive
              />
            </ProjectIconPicker>
              ...
              {shouldShowProjectPathEntry && (
                <div className="mb-2 px-1">
                  {isElectron && (
                    ...
                    >
                      <FolderIcon fill="currentColor" className="size-3.5" />
